...
#     live_recorder = recorder_module.DouyuRecorder(312212, check_flv = False)
    ...
    if roomInfo['live_status'] == '1':
        ...
        qn = input("输入要录制的清晰度")
        live_url = live_recorder.getLiveUrl(qn = qn) #请查看roomInfo['live_rates']
        print(live_url)
        download_thread = recorder_module.DownloadThread(live_recorder)
